...
return new class extends Migration
{
    ...
    {
        Schema::create('erp_expense_cash_reconsile', function (Blueprint $table) {
            $table->comment('ERP expense & cash transaction reconciliation rows');
    ...
    {
        Schema::dropIfExists('erp_expense_cash_reconsile');
    }
};
