...
return new class extends Migration
{
    ...
    {
        Schema::create('expense_cash_recon_sessions', function (Blueprint $table) {
            $table->comment('Header record for each expense & cash reconciliation session');
    ...
    {
        Schema::dropIfExists('expense_cash_recon_sessions');
    }
};
