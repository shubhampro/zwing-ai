...
return new class extends Migration
{
    ...
    {
        Schema::create('zwing_stock_reconsile', function (Blueprint $table) {
            $table->comment('Zwing (POS) stock reconciliation rows');
    ...
    {
        Schema::dropIfExists('zwing_stock_reconsile');
    }
};
