...
class UpdateOrganizationDatabaseConnectionRequest extends FormRequest
{
    public function authorize(): bool
    {
        /** @var OrganizationDatabaseConnection $connection */
        $connection = $this->route('organizationDatabaseConnection');
