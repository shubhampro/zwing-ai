...
import { create, index, report, show } from '@/routes/report-consolidation';
...
export default function ReportConsolidationIndex({
    sessions,
}: {
    sessions: SessionRow[];
}) {
    ...
    return (
        <>
            <Head title="Report consolidation" />

            <div className="flex flex-col gap-6 p-4 md:p-6">
                <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                    <Heading
                        title="Report consolidation"
                        description="Pull Zwing Invoice and MOP reports for a date range and compare totals per invoice."
                    />
                    <Button size="sm" asChild>
                        <Link href={create.url()}>New consolidation</Link>
                    </Button>
                </div>
                            ...
                            {sessions.length === 0 && (
                                <tr>
                                    ...
                                    >
                                        ...
                                        by pulling Invoice and MOP reports from
                                        Zwing.
                                    </td>
                                </tr>
                            )}
...
ReportConsolidationIndex.layout = {
    breadcrumbs: [
