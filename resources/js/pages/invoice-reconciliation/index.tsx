...
import { create, index, report, show } from '@/routes/invoice-reconciliation';
...
export default function InvoiceReconciliationIndex({
    ...
    return (
        <>
            <Head title="Invoice reconciliation" />

            <div className="flex flex-col gap-6 p-4 md:p-6">
                <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                    <Heading
                        title="Invoice reconciliation"
                        description="Upload Zwing and ERP CSVs to reconcile invoice data. Each upload creates a new session."
                    />
...
InvoiceReconciliationIndex.layout = {
    breadcrumbs: [
