...
const REQUIRED_COLUMNS = ['site_code', 'barcode', 'icode', 'batch_no', 'sprefcode', 'stock_point_name', 'qty'] as const;
    ...
    return (
        <>
            ...
            <div className="flex flex-col gap-6 p-4 md:p-6">
                <div>
                    <h1 className="text-xl font-semibold tracking-tight">New reconciliation</h1>
                    <p className="text-muted-foreground mt-1 text-sm">
                        Upload a Zwing (POS) export, an ERP export, or both. At least one file is required.
                    </p>
                </div>
                    ...
                    <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
                        <div className="flex flex-col gap-3 rounded-lg border border-sidebar-border/70 p-5 dark:border-sidebar-border">
                            <div>
                                ...
                                <p className="text-muted-foreground mt-0.5 text-sm">MySQL / vendor-side stock export</p>
                            </div>
                            <div className="space-y-2">
                                <Label htmlFor="reconciliation-csv-zwing">CSV file</Label>
                                <input
                        ...
                        <div className="flex flex-col gap-3 rounded-lg border border-sidebar-border/70 p-5 dark:border-sidebar-border">
                            <div>
                                ...
                                <p className="text-muted-foreground mt-0.5 text-sm">PostgreSQL / central inventory export</p>
                            </div>
                            <div className="space-y-2">
                                <Label htmlFor="reconciliation-csv-erp">CSV file</Label>
                                <input
