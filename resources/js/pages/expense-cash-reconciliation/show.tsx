...
export default function ExpenseCashReconciliationShow({
    session,
}: {
    session: SessionData;
}) {
    ...
    return (
        <>
            <Head title={`Expense & cash reconciliation #${session.id}`} />
                ...
                <DialogContent>
                    <DialogHeader>
                        ...
                        <DialogDescription>
                            ...
                            and all associated Zwing and ERP expense & cash
...
ExpenseCashReconciliationShow.layout = {
    breadcrumbs: [
