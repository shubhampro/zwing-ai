...
import { destroy } from '@/actions/App/Http/Controllers/ExpenseCashReconciliationController';
            ...
            <DialogContent>
                <DialogHeader>
                    ...
                    <DialogDescription>
                        ...
                        and all associated Zwing and ERP expense & cash rows.
...
export default function ExpenseCashReconciliationIndex({
    sessions,
}: {
    sessions: SessionRow[];
}) {
    ...
    return (
        <>
            <Head title="Expense & cash reconciliation" />

            <div className="flex flex-col gap-6 p-4 md:p-6">
                <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                    <Heading
                        title="Expense & cash reconciliation"
                        description="Upload Zwing and ERP CSVs to reconcile store expense and cash transaction data. Each upload creates a new session."
                    />
                            ...
                            {sessions.length === 0 && (
                                <tr>
                                    ...
                                    >
                                        ...
                                        by uploading Zwing and ERP CSV files.
                                    </td>
                                </tr>
                            )}
                            {sessions.map((s) => (
...
ExpenseCashReconciliationIndex.layout = {
    breadcrumbs: [
